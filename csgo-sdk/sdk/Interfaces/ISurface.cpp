...
void ISurface::DrawPrintText(const wchar_t *text, int textLen, FontDrawType_t drawType) {
	...
	return Util::GetVFunc<OriginalFn>(this, 28)(this, text, textLen, drawType);
}
...
void ISurface::DrawSetTextureRGBA(int id, const unsigned char* rgba, int wide, int tall) {
	...
	return Util::GetVFunc<OriginalFn>(this, 37)(this, id, rgba, wide, tall);
}

void ISurface::DrawSetTexture(int id) {
	typedef void(__thiscall* OriginalFn)(void*, int);
	return Util::GetVFunc<OriginalFn>(this, 38)(this, id);
}

int	ISurface::CreateNewTextureID(bool procedural) {
	typedef int(__thiscall* OriginalFn)(void*, bool);
	return Util::GetVFunc<OriginalFn>(this, 43)(this, procedural);
}

HFont ISurface::Create_Font() {
	typedef HFont(__thiscall* OriginalFn)(void*);
	return Util::GetVFunc<OriginalFn>(this, 71)(this);
}
...
bool ISurface::SetFontGlyphSet(HFont font, const char *windowsFontName, int tall, int weight, int blur, int scanlines, int flags, int nRangeMin, int nRangeMax) {
	...
	return Util::GetVFunc<OriginalFn>(this, 72)(this, font, windowsFontName, tall, weight, blur, scanlines, flags, nRangeMin, nRangeMax);
}
...
void ISurface::GetTextSize(HFont font, const wchar_t *text, int &wide, int &tall) {
	...
	return Util::GetVFunc<OriginalFn>(this, 79)(this, font, text, wide, tall);
}

void ISurface::DrawOutlinedCircle(int x, int y, int radius, int segments) {
	typedef void(__thiscall* OriginalFn)(void*, int, int, int, int);
	return Util::GetVFunc<OriginalFn>(this, 103)(this, x, y, radius, segments);
}
...
void ISurface::DrawTexturedPolygon(int n, Vertex_t *pVertice, bool bClipVertices) {
	...
	return Util::GetVFunc<OriginalFn>(this, 106)(this, n, pVertice, bClipVertices);
}

void ISurface::DrawTexturedRect(int x0, int y0, int x1, int y1) {
	typedef void(__thiscall* OriginalFn)(void*, int, int, int, int);
	return Util::GetVFunc<OriginalFn>(this, 41)(this, x0, y0, x1, y1);
}

bool ISurface::IsTextureIDValid(int id) {
	return Util::GetVFunc<bool(__thiscall*)(void*, int)>(this, 42)(this, id);
}
