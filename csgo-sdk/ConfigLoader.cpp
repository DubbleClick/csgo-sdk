...
void CConfigLoader::Setup() {
	...
	SetupValue(Config->Ragebot.AutoWallDmg, 10.f, strenc("Ragebot"), strenc("AutoWallDamage"));
	SetupValue(Config->Ragebot.HitChanceAmt, 50.f, strenc("Ragebot"), strenc("HitChanceAmount"));
