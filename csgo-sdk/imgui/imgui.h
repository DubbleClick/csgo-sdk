...
extern float GLOBAL_H_COLOR;
extern bool GLOBAL_RAINBOW;
...
namespace ImGui
{
	...
	IMGUI_API ImU32			GetColorU32(const ImColor& col);
	...
	void RenderTextTitle(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, ImGuiAlign align, const ImVec2* clip_min, const ImVec2* clip_max);
	// Clipping
...
struct ImDrawList
{
	...
	IMGUI_API void  AddLineColoured(const ImVec2& a, const ImVec2& b, ImU32 col, float thickness = 1.f);
	// Channels
